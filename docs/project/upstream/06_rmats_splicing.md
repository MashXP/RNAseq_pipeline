...
Before running rMATS, the script executes `utils/generate_bam_lists.py`. This utility parses the project metadata and generates the necessary input files. For a detailed breakdown of the logic, see [Upstream Utility Dissection](file:///mnt/22T/phongdinh/RNAseq_pipeline/docs/project/upstream/utils_dissection.md#3-generate_bam_listspy).
...
bash scripts_upstream/06_rmats_splicing.sh
```
