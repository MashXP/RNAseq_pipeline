# [[02_dge_analysis/scripts/downstream/14_alluvial_plot.R]]
...
# Path Setup (Relative to 02_dge_analysis/scripts/downstream/)
human_tables_dir <- file.path(results_root, "02_dge_analysis", "human", "tables")
canine_tables_dir   <- file.path(results_root, "02_dge_analysis", "canine", "tables")
output_dir       <- file.path(results_root, "02_dge_analysis", "comparative", "figures")
table_dir        <- file.path(results_root, "02_dge_analysis", "comparative", "tables")
...
comparisons <- list(
  list(cols = c("h_h9_r", "d_ul1_r"), labels = c("Human:H9", "Canine:UL1"), title = "Romidepsin Response (H9 vs UL1)", name = "14_alluvial_Romidepsin_H9_vs_UL1"),
  list(cols = c("h_supm2_r", "d_cnk89_r"), labels = c("Human:SUPM2", "Canine:CNK89"), title = "Romidepsin Response (SUPM2 vs CNK89)", name = "14_alluvial_Romidepsin_SUPM2_vs_CNK89"),
  list(cols = c("h_h9_k", "d_ul1_k"), labels = c("Human:H9", "Canine:UL1"), title = "Kromastat Response (H9 vs UL1)", name = "14_alluvial_Kromastat_H9_vs_UL1"),
  list(cols = c("h_supm2_k", "d_cnk89_k"), labels = c("Human:SUPM2", "Canine:CNK89"), title = "Kromastat Response (SUPM2 vs CNK89)", name = "14_alluvial_Kromastat_SUPM2_vs_CNK89")
)
...
make_alluvial_plot(
  ...
  filename_base = "14_alluvial_hallmark_Romidepsin"
)
...
make_alluvial_plot(
  ...
  filename_base = "14_alluvial_hallmark_Kromastat"
)
...
make_alluvial_plot(
  ...
  filename_base = "14_alluvial_aggressive"
)
...
make_alluvial_plot(
  ...
  filename_base = "14_alluvial_indolent"
)
...
if (length(all_alluvial_data) > 0) {
  ...
  ggsave(file.path(output_dir, "14_alluvial_gene_flow.png"), p_alluvial, width = 18, height = 10, bg = "white", dpi = 300)
  ...
  write_csv(flow_summary, file.path(table_dir, "14_alluvial_gene_flow_summary.csv"))
  ...
  write_csv(gene_report, file.path(table_dir, "14_alluvial_gene_flow_detailed.csv"))
  message("  [OK] Saved Tables: 14_alluvial_gene_flow_summary.csv, 14_alluvial_gene_flow_detailed.csv")
}
