# [[02_dge_analysis/scripts/downstream/16_ortholog_nes_overlap.R]]
...
plot_nes_overlap <- function(pair) {
  ...
  ggsave(file.path(plots_dir, paste0("16_nes_bar_", pair$id, ".png")), p, width = 14, height = 12, bg = "white", dpi = 300)
  write_csv(merged, file.path(tables_dir, paste0("16_nes_overlap_", pair$id, ".csv")))
}
