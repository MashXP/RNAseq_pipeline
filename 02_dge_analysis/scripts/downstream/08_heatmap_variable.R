# [[02_dge_analysis/scripts/downstream/08_heatmap_variable.R]]
...
if (length(args) == 0) {
  stop("Usage: Rscript 08_heatmap_variable.R <Group> [Species]")
}
...
png(paste0(res_dir, "/figures/08_heatmap_top_variable.png"),
...
dev.off()
message("[OK] Top-var heatmap  -> 08_heatmap_top_variable.png",
