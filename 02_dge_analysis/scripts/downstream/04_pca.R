# [[02_dge_analysis/scripts/downstream/04_pca.R]]
...
if (length(args) == 0) {
  stop("Usage: Rscript 04_pca.R <Group> [Species]")
}
...
ggsave(file.path(res_dir, "figures/04_pca_combined.png"), p_combined, width = 11, height = 7, bg = "white")
message("[OK] Saved Combined PCA: 04_pca_combined.png")
...
for (cl in cell_lines) {
  ...
  if (ncol(vsd_cell) >= 2) {
    ...
    filename_cl <- paste0("04_pca_", cl, ".png")
