...
- **Input**:
    ...
    - **Metadata**: `_data/_metadata/drPhuong_Sample_Data_Table.csv` (CSV, mapping groups to treatments).
...
## 1. Metadata Parsing
```r
metadata_raw <- read_csv("_data/_metadata/drPhuong_Sample_Data_Table.csv", skip = 1) %>%
