# [[test_downstream/test_04_04_heatmap_pathway.R]]
# Goal: Generate Pathway-specific Heatmap for specific group. (TEST)
...
if (length(args) < 2) {
  stop("Usage: Rscript test_04_04_heatmap_pathway.R <Group> <Species>")
}
group_name <- args[1]
species_name <- args[2]
