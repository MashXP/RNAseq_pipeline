# [[test_downstream/test_03_enrichment.R]]
...
for (dose in names(results_list)) {
  ...
  # --- DEVIATION: Relaxed raw pvalue ORA threshold for small mock dataset
...
# 4. Save results
# --- DEVIATION: Output to test-specific directories
save(enrichment_results_all, file = paste0("./.RData_test/", group_name, "/03_enrichment_results.RData"))
