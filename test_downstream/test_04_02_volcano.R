# [[test_downstream/test_04_02_volcano.R]]
# Goal: Generate Volcano plots for all doses in specific group. (TEST)
...
if (length(args) < 2) {
  stop("Usage: Rscript test_04_02_volcano.R <Group> <Species>")
}
group_name <- args[1]
species_name <- args[2]
