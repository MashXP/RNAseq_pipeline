# [[test_downstream/test_04_07_enrichment_dotplot.R]]
# Goal: Generate GSEA Dotplots for specific group. (TEST)
...
if (length(args) < 2) {
  stop("Usage: Rscript test_04_07_enrichment_dotplot.R <Group> <Species>")
}
group_name <- args[1]
species_name <- args[2]
