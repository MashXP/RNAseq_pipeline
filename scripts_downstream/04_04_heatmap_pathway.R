...
if (length(args) == 0) stop("Usage: Rscript 04_04_heatmap_pathway.R <Group>")
...
if ("cell_line" %in% colnames(colData(dds))) {
  ...
  for (cl in cell_lines) {
    ...
    png(paste0(res_dir, "/figures/04_04_heatmap_shared_deg_", cl, ".png"), 
    ...
    message("  [OK] Saved Shared Leading-Edge heatmap -> 04_04_heatmap_shared_deg_", cl, ".png")
  }
}
